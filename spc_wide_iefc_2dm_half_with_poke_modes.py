...
misc.save_fits(iefc_dir/'response-data'/f'spc_wide_iefc_2dm_poke_response_matrix_{date}.fits', ensure_np_array(response_matrix))
misc.save_fits(iefc_dir/'response-data'/f'spc_wide_iefc_2dm_poke_response_cube_{date}.fits', ensure_np_array(response_cube))

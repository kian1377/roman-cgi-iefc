...
#     elif use_defocus_lens != 0: d_lens_fold4 = d_lens_fold4 + 0.001*u.m # doublet is 1 mm longer than singlet, so make up for it
    ...
    if HLC.use_fpm: 
        fpm_pxscl_lamD = ( HLC.FPM.pixelscale_lamD * HLC.FPM.wavelength_c.to(u.meter) / inwave2.wavelength.to(u.meter) ).value
        ...
        inwave2.wavefront *= HLC.fpm_phasor[0,0]

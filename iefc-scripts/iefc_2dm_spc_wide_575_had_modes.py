...
utils.save_fits(response_dir/f'spc_wide_575_had_modes_response_matrix_{today}.fits', response_matrix)
utils.save_fits(response_dir/f'spc_wide_575_had_modes_response_cube_{today}.fits', response_cube)

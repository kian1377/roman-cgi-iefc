...
# probe_modes = utils.create_poke_probes([(10,34), (10,35)], plot=True)
...
utils.save_fits(response_dir/f'spc_wide_575_poke_modes_response_matrix_{today}.fits', response_matrix)
utils.save_fits(response_dir/f'spc_wide_575_poke_modes_response_cube_{today}.fits', response_cube)
